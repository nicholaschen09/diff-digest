            ...
            <div className="flex items-center gap-2">
              <div className="relative mr-2 self-center" style={{ width: 150 }}>
                <Listbox value={reverseOrder ? "oldest" : "newest"} onChange={val => setReverseOrder(val === "oldest")}>
                  {({ open }) => (
                    <Fragment>
                      <Listbox.Button className="w-full h-[36px] px-3 py-1 text-base font-medium rounded-lg bg-zinc-800 text-white border border-zinc-700 focus:outline-none focus:ring-2 focus:ring-blue-500 pr-8 flex items-center justify-between whitespace-nowrap">
                        <span className="whitespace-nowrap">{reverseOrder ? "Oldest First" : "Newest First"}</span>
                        <span className="pointer-events-none ml-2 text-gray-400">
