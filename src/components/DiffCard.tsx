                        ...
                        <button
                            ...
                            className={cn(
                                ...
                                isGenerating
                                    ...
                                    : "bg-gradient-to-r from-blue-600 to-blue-700 text-white hover:from-blue-500 hover:to-blue-600 shadow-sm"
                            )}
                        >
                            {isGenerating ? (
                                <>
                    ...
                    <div className="p-4">
                        ...
                        {(devNote || marketingNote) && (
                            <div className="bg-zinc-700/50 rounded-lg overflow-hidden shadow-inner">
                                <div className="bg-gradient-to-r from-zinc-600 to-zinc-700 px-4 py-2 flex items-center">
